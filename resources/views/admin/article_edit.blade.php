...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin.info')}}">首页</a> &raquo; <a href="{{url('admin.article')}}">文章列表</a> &raquo; 编辑文章
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="article_categoryid">
    							...
    							<option value="{{$category->category_id}}" @if($category->category_id == $field->article_categoryid) selected @endif>{{$category->category_name}}</option>
    							@endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" size="50" name="article_thumb" value="{{$field->article_thumb}}">
                    ...
                    <tr>
                        <th>图片预览：</th>
                        <td>
                            <img id="img_thumb" src="/{{$field->article_thumb}}" alt="" style="max-width:350px;max-height:200px">
                        </td>
                    </tr>
                    <tr>
                        <th>文章内容：</th>
                        <td>
                            ...
                            <script id="editor" type="text/plain" name="article_content" style="width:970px;height:500px;">{!! $field->article_content !!}</script>
